...
Write-Host 'Setting up aws-infra prerequisites...' -ForegroundColor Cyan
...
terraform init
Write-Host 'aws-infra prerequisites and minimum versions look good.' -ForegroundColor Green
