...
def setup_logger():
    ...
    # Fix Windows console encoding issues (cp950) by using UTF-8
    import io
    if sys.platform == 'win32':
        # On Windows, wrap stdout with UTF-8 encoding to handle emojis and Chinese characters
        try:
            sys.stdout.reconfigure(encoding='utf-8')
        except:
            # If reconfigure fails, create a new TextIOWrapper
