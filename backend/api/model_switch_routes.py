...
class GeminiConfigRequest(BaseModel):
    ...
    scammer_model: str = Field("gemini-3.1-flash-lite-preview", description="騙徒模型 ID")
    victim_model: str = Field("gemini-3.1-flash-lite-preview", description="受害者模型 ID")
    expert_model: str = Field("gemini-3.1-flash-lite-preview", description="專家模型 ID")
    recorder_model: str = Field("gemini-3.1-flash-lite-preview", description="記錄員模型 ID")
