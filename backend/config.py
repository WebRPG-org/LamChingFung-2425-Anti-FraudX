...
class DatabaseConfig:
    ...
    # Firestore
    FIRESTORE_ENABLED: bool = os.getenv("FIRESTORE_ENABLED", "true").lower() == "true"
    FIRESTORE_PROJECT_ID: str = os.getenv("GCP_PROJECT_ID", "anti-fraudx")
    FIRESTORE_DATABASE: str = os.getenv("FIRESTORE_DATABASE", "anti-fraudx-db")
    
    # RAG
    RAG_DEFAULT_RESULTS: int = 3
    RAG_MAX_RESULTS: int = 10
    RAG_USE_FIRESTORE: bool = os.getenv("RAG_USE_FIRESTORE", "true").lower() == "true"
    RAG_SAVE_CONVERSATIONS: bool = os.getenv("RAG_SAVE_CONVERSATIONS", "true").lower() == "true"
...
class GeminiConfig:
    ...
    SCAMMER_MODEL_ID: str = os.getenv("GEMINI_MODEL_SCAMMER", "gemini-3.1-flash-lite-preview")
    VICTIM_MODEL_ID: str = os.getenv("GEMINI_MODEL_VICTIM", "gemini-3.1-flash-lite-preview")
    EXPERT_MODEL_ID: str = os.getenv("GEMINI_MODEL_EXPERT", "gemini-3.1-flash-lite-preview")
    RECORDER_MODEL_ID: str = os.getenv("GEMINI_MODEL_RECORDER", "gemini-3.1-flash-lite-preview")
