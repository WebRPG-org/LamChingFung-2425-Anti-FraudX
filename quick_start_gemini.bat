...
if not exist backend\.env (
    ...
    echo   GEMINI_MODEL_SCAMMER=gemini-3.1-flash-lite-preview
    echo   GEMINI_MODEL_VICTIM=gemini-3.1-flash-lite-preview
    echo   GEMINI_MODEL_EXPERT=gemini-3.1-flash-lite-preview
    echo   GEMINI_MODEL_RECORDER=gemini-3.1-flash-lite-preview
    echo.
    pause
    exit /b 1
)
